...
export const ControlAccount = {
    ...
    register: async (req, res) => {
        ...
        try {
            ...
            console.log({ token: accessToken, data: newMemo.categories });
            return res.json({ token: accessToken, data: newMemo.categories });
        } catch (error) {
            console.log(error);
            return res.json({ errcode: '003' });
        }
    },
    // 로그인 관련 함수
    login: async (req, res) => {
        ...
        try {
            ...
            return res.json({ token: accessToken, data: userMemo.categories });
        } catch (error) {
